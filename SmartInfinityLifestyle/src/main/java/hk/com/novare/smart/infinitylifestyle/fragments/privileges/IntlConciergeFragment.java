 ...
 */
public class IntlConciergeFragment extends Fragment {
    private static final String TAG = "hk.com.novare.smart.infinitylifestyle";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_premium_intlconcierge, container, false);
        Log.i(TAG, "in IntlConciergeFragment");
        return rootView;
    }
}
